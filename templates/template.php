	...
	<section id="slider">
		<div id="home-carousel" class="carousel slide" data-ride="carousel">			
			<div class="carousel-inner">
				<div class="item active" style="background-image: url(images/slider/music_school.jpg)">
				...
				<div class="col-md-8 col-md-offset-2 col-sm-12">
					<div class="st-testimonials">
						...
						<div class="item active text-center">
							<p>"As a student of Pinelands Music School, I feel like I've learn how to play music well and stuff and, like, the teachers and lit af"</p>
							<div class="st-border"></div>
							<div class="client-info">
								<h5>xXx420BlazexXx</h5>
								<span>Student - Grade 7</span>
							</div>
						</div>

						<div class="item text-center">
							<p>"I'm a teacher at Pinelands Music School teaching the traditional Khura'inese string instrument Dahmalan. I find the new webapp very easy to use, and allows me to more easily set up lessons with students."</p>
							<div class="st-border"></div>
							<div class="client-info">
								<h5>Pees'lubn Andistan'dhin</h5>
								<span>Head Monk of Tehm'pul Temple</span>
							</div>
						</div>
